    ...
    private fun setUpUI() {
        ...
        navController.addOnDestinationChangedListener { _, destination, _ ->
            ...
            when{
                ...
                dashBoardActivityBinding.appBarDashboard.imageView2.visibility = View.GONE
                    dashBoardActivityBinding.appBarDashboard.textView3.visibility = View.GONE
                    dashBoardActivityBinding.appBarDashboard.toolBarNotificationIcon.visibility = View.GONE
                ...
                dashBoardActivityBinding.appBarDashboard.toolBarNotificationIcon.visibility = View.VISIBLE
                    ...
                    dashBoardActivityBinding.appBarDashboard.imageView2.visibility = View.VISIBLE
                    dashBoardActivityBinding.appBarDashboard.textView3.visibility = View.VISIBLE
                    dashBoardActivityBinding.appBarDashboard.toolBarNotificationIcon.visibility = View.VISIBLE
            }
        }
        }
