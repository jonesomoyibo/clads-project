...
class SpecialtyListAdapter(val context: Activity, var specialityList: List<Specialty>):RecyclerView.Adapter<SpecialtyListAdapter.SpecialtyListViewHolder>() {
    ...
    fun <T:Specialty> setList(list:List<T>){
        specialityList = list
    }
}